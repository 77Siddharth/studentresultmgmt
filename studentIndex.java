...
public class studentIndex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Roll Number to fetch result");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                setVisible(false);
                new studentPage(rollNo).setVisible(true);
            }else{
                JOptionPane.showMessageDialog(null, "roll number doesnt exists or result is not ready" + "'"+rs+"'");
            }
        }
